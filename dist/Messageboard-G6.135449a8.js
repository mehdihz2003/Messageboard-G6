...
module.bundle.HMR_BUNDLE_ID = "ddcdccf1135449a8";
"use strict";
...
},{}],"7h78P":[function(require,module,exports,__globalThis) {
var _newFirebaseJs = require("./newFirebase.js");
var _displayJs = require("./display.js");
var _profanityJs = require("./profanity.js");
var _searchJs = require("./search.js");
console.log("main.js loaded");
// Listen for Firebase changes and update the search module
(0, _newFirebaseJs.listenForMessageChanges)((messagesArray)=>{
    (0, _searchJs.updateMessages)(messagesArray);
});
...
document.addEventListener('DOMContentLoaded', ()=>{
    ...
    (0, _searchJs.initializeSearch)((0, _displayJs.displayMessages));
...
messageForm.addEventListener("submit", async (event)=>{
    ...
    const userMessage = (0, _profanityJs.censorBadWords)(formData.get("message"));
    ...
    try {
        ...
        //  return;
        // }
        const bannedUsers = await (0, _newFirebaseJs.fetchBannedUsersFromFirebase)();
        if (bannedUsers.some((user)=>user.user === userName)) {
            alert("This username is banned, try again.");
            return;
        }
        const audio = new Audio(new URL(require("8cf284e6b8936bcb")).href);
        audio.play();
        await (0, _newFirebaseJs.addMessageToFirebase)(userMessage, userName, selectedColor, messageDate);
        event.target.reset();
...
},{"./newFirebase.js":"3pLcT","./display.js":"lA8tp","./profanity.js":"6NBfr","./search.js":"5cAn1","8cf284e6b8936bcb":"ftRV4"}],"3pLcT":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "addMessageToFirebase", ()=>addMessageToFirebase);
parcelHelpers.export(exports, "fetchMessagesFromFirebase", ()=>fetchMessagesFromFirebase);
parcelHelpers.export(exports, "updateLikeDislikeFirebase", ()=>updateLikeDislikeFirebase);
parcelHelpers.export(exports, "addBannedUsersToFirebase", ()=>addBannedUsersToFirebase);
parcelHelpers.export(exports, "fetchBannedUsersFromFirebase", ()=>fetchBannedUsersFromFirebase);
parcelHelpers.export(exports, "patchBanned", ()=>patchBanned);
parcelHelpers.export(exports, "deleteMessageFromFirebase", ()=>deleteMessageFromFirebase);
...
async function addMessageToFirebase(message, user, color) {
    ...
    const newMessageRef = await (0, _database.push)(messagesRef, messageData);
    return {
...
async function fetchMessagesFromFirebase() {
    const messagesRef = (0, _database.ref)(db, "messages");
    const snapshot = await (0, _database.get)(messagesRef);
...
async function updateLikeDislikeFirebase(messageId, type) {
    const messageRef = (0, _database.ref)(db, `messages/${messageId}`);
    const snapshot = await (0, _database.get)(messageRef);
    ...
    await (0, _database.update)(messageRef, updatedData);
}
async function addBannedUsersToFirebase(user) {
    const bannedUsersRef = (0, _database.ref)(db, "bannedUsers");
    const newBannedUsersRef = await (0, _database.push)(bannedUsersRef, {
        user
    });
    return {
        id: newBannedUsersRef.key,
        user
    };
}
async function fetchBannedUsersFromFirebase() {
    const bannedUsersRef = (0, _database.ref)(db, "bannedUsers");
    const snapshot = await (0, _database.get)(bannedUsersRef);
    if (!snapshot.exists()) return [];
    const data = snapshot.val();
    return Object.keys(data).map((key)=>({
            id: key,
...
async function patchBanned(id, banned) {
    const messageRef = (0, _database.ref)(db, `messages/${id}`);
    await (0, _database.update)(messageRef, {
        banned
    });
    return {
        id,
...
async function deleteMessageFromFirebase(messageId) {
    try {
        const messageRef = (0, _database.ref)(db, `messages/${messageId}`);
        await (0, _database.remove)(messageRef);
        console.log("Message deleted successfully");
    } catch (error) {
        console.error("Error deleting message:", error);
    }
}
function listenForMessageChanges(callback) {
    const messagesRef = (0, _database.ref)(db, "messages");
    (0, _database.onValue)(messagesRef, (snapshot)=>{
        if (!snapshot.exists()) {
            callback([]);
            return;
        }
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}],"eqXsT":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _database = require("@firebase/database");
...
var _fitTextJs = require("./fitText.js");
var _newFirebaseJs = require("./newFirebase.js");
...
function displayMessages(messagesArray) {
    ...
    [
        ...
        if (!filteredMessageIds.has(child.id)) child.remove();
    });
    ...
    for(let i = 0; i < messagesArray.length; i++){
        ...
        if (messagesArray[i].dateString != undefined) messageDate = new Date(Date.parse(messageDate));
        else messageDate = current_date;
        console.log(messageDate);
    ...
    **/ const rotation = getRotationFromId(messagesArray[i].id);
        ...
        if (messagesArray[i].color) messageDiv.classList.add(messagesArray[i].color);
        ...
        likeButton.addEventListener("click", async ()=>{
            await (0, _newFirebaseJs.updateLikeDislikeFirebase)(messagesArray[i].id, "like");
            likeCount.textContent = parseInt(likeCount.textContent) + 1;
        });
        dislikeButton.addEventListener("click", async ()=>{
            await (0, _newFirebaseJs.updateLikeDislikeFirebase)(messagesArray[i].id, "dislike");
        ...
        setTimeout(()=>{
            (0, _fitTextJs.fitTextToContainer)(textWrapper);
        }, 0);
            ...
            if (!messageDiv.querySelector(".ban-button")) {
                ...
                banButton.addEventListener("click", async (event)=>{
                    ...
                    if (confirmBan) {
                        ...
                        await (0, _newFirebaseJs.addBannedUsersToFirebase)(username, true);
                        const users = await (0, _newFirebaseJs.fetchMessagesFromFirebase)();
...
document.getElementById("resetButton").addEventListener("click", async ()=>{
    ...
    if (confirmation) try {
        ...
        const messages = await (0, _newFirebaseJs.fetchMessagesFromFirebase)();
...
},{"./fitText.js":"jAgDU","./newFirebase.js":"3pLcT","@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}],"jAgDU":[function(require,module,exports,__globalThis) {
// fitText.js
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "fitTextToContainer", ()=>fitTextToContainer);
function fitTextToContainer(wrapperElement, minFontSize = 6) {
    ...
    let attempts = 0;
    while((wrapperElement.scrollHeight > containerHeight || wrapperElement.scrollWidth > containerWidth) && fontSize > minFontSize && attempts < MAX_ATTEMPTS){
        fontSize -= 1.2;
        attempts++;
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}],"6NBfr":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "censorBadWords", ()=>censorBadWords);
var _profanityListJs = require("./profanityList.js");
function censorBadWords(text) {
    const regex = new RegExp(`\\b(${(0, _profanityListJs.profanityList).join("|")})\\b`, "gi");
    return text.replace(regex, (match)=>"*".repeat(match.length));
}

},{"./profanityList.js":"ibIoY","@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}],"ibIoY":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "profanityList", ()=>profanityList);
const profanityList = [
    "4r5e",
    "5h1t",
    "5hit",
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}],"5cAn1":[function(require,module,exports,__globalThis) {
/**
 * Search module for filtering messages by username and content (Linns feature)
 */ var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "initializeSearch", ()=>initializeSearch);
parcelHelpers.export(exports, "updateMessages", ()=>updateMessages);
parcelHelpers.export(exports, "performSearch", ()=>performSearch);
parcelHelpers.export(exports, "filterMessages", ()=>filterMessages);
let allMessages = [];
let searchCallback = null;
function initializeSearch(filterCallback) {
...
function performSearch(searchTerm = "") {
    ...
    if (searchCallback) searchCallback(filteredMessages);
}
